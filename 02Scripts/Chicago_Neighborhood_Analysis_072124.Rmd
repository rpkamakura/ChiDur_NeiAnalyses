...
#             df       AIC
# bestf1mod.1  8 -3348.053
# bestf1mod.2  9 -3550.972

#write.csv(f1sum.2$coefficients$mean, "../04Outputs/Chicago/Chi_SC_Best_2mod.csv")

###################################Afternoon Temperature - linreg
mods_m2 <- paste(rep("AftTemp ~", 2), c(f1, f2))
...
#             df      AIC
# bestf2mod.1  4 4.852855
# bestf2mod.2  4 4.852855

#write.csv(f2sum.1$coefficients, "../04Outputs/Chicago/Chi_Temperature_Best_2mod.csv")
...
#             df       AIC
# bestf3mod.1  8 -1873.089
# bestf3mod.2  8 -2193.759


#write.csv(f3sum.2$coefficients$mean, "../04Outputs/Chicago/Chi_Gardenscape_Best_2mod.csv")
...
#             df       AIC
# bestf4mod.1  6 -3246.986
# bestf4mod.2  8 -3573.694

#write.csv(f4sum.2$coefficients$mean, "../04Outputs/Chicago/Chi_SimpsonSpp_Best_2mod.csv")
...
#             df       AIC
# bestf5mod.1  7 -2616.589
# bestf5mod.2  8 -2794.004

#write.csv(f5sum.2$coefficients$mean, "../04Outputs/Chicago/Chi_SimpsonGen_Best_2mod.csv")
...
#             df       AIC
# bestf6mod.1  6 -35.79276
# bestf6mod.2  7 -35.91381

#write.csv(f6sum.2$coefficients, "../04Outputs/Chicago/Chi_AvgBA_Best_2mod.csv")
...
#write.csv(f7sum.1$coefficients, "../04Outputs/Chicago/Chi_NumTrees_Best_2mod.csv")
...
#             df       AIC
# bestf8mod.1  7 -1589.820
# bestf8mod.2  8 -1622.265

#write.csv(f8sum.2$coefficients, "../04Outputs/Chicago/Chi_UrbanApp_Best_2mod.csv")
...
#             df       AIC
# bestf9mod.1  8 -3583.963
# bestf9mod.2  9 -4352.007

#write.csv(f9sum.2$coefficients, "../04Outputs/Chicago/Chi_Discol_Best_2mod.csv")
...
#              df       AIC
# bestf10mod.1  7 -3126.811
# bestf10mod.2  5 -3255.664


#write.csv(f10sum.2$coefficients, "../04Outputs/Chicago/Chi_DBK_Best_2mod.csv")
...
#              df       AIC
# bestf11mod.1  8 -3314.847
# bestf11mod.2  9 -3703.837

#write.csv(f11sum.2$coefficients, "../04Outputs/Chicago/Chi_CS_Best_2mod.csv")
...
modList <- list(f1sum.2, f2sum.1, f3sum.2, f4sum.2, f5sum.2, f6sum.2, f7sum.1, f8sum.2, f9sum.2, f10sum.2, f11sum.2)
...
write.csv(ModOverview, "../04Outputs/Chicago/Chi_ModelOverviewResults_2mod.csv")
