...
f1 <- "PercResTree + Change_PWnHL + Change_MedHHI + Avg_Rmov"
f2 <- "PercResTree + SVI + Change_PWnHL + Change_MedHHI + Avg_Rmov"
f3 <- "PercResTree + NumReno_since11 + NumConst_since11 + Change_PWnHL + Change_MedHHI + Avg_Rmov"

# #############################Sidewalk cutout
# mods_m1 <- paste(rep("PercSC ~", 2), c(f1, f2, f3))
# 
...
# 
# 
# #write.csv(f1sum.2$coefficients$mean, "../04Outputs/Durham/Dur_SC_Best_2mod4.csv")
# 
# 
# ###################################Afternoon Temperature - linreg
# mods_m2 <- paste(rep("AftTemp10m ~", 2), c(f1, f2, f3))
# 
...
# 
# 
# #write.csv(f2sum.2$coefficients, "../04Outputs/Durham/Dur_Temperature_Best_2mod4.csv")
# 
# ###########################Percent Gardenscape 3 or 4
# mods_m3 <- paste(rep("PercGar3o4 ~", 2), c(f1, f2, f3))
# 
# 
...
#write.csv(f3sum.2$coefficients$mean, "../04Outputs/Durham/Dur_Gardenscape_Best_2mod4.csv")
...
#             df       AIC
# bestf5mod.1  5 -1165.843
# bestf5mod.2  5 -1165.843
# bestf5mod.3  6 -1231.234


#write.csv(f5sum.2$coefficients$mean, "../04Outputs/Durham/Dur_SimpsonGen_Best_2mod4.csv")


###AvgBA
mods_m6 <- paste(rep("AvgBA ~", 2), c(f1, f2, f3))
...
#write.csv(f6sum.1$coefficients, "../04Outputs/Durham/Dur_AvgBA_Best_2mod4.csv")

##Number of Trees
f1.2 <- "PercRes_z + Change_PWnHL + Change_MedHHI + Avg_Rmov"
f2.2 <- "PercRes_z + SVI + Change_PWnHL + Change_MedHHI + Avg_Rmov"
f3.2 <- "PercRes_z + NumConst_since11 + NumReno_since11 + Change_PWnHL + Change_MedHHI + Avg_Rmov"
...
#             df       AIC
# bestf8mod.1  6 -694.3844
# bestf8mod.2  7 -715.4138
# bestf8mod.3  7 -787.0608
...
#             df       AIC
# bestf9mod.1  6 -722.6571
# bestf9mod.2  7 -788.6725
# bestf9mod.3  8 -806.3235
...
#              df       AIC
# bestf10mod.1  6 -1413.501
# bestf10mod.2  7 -1436.113
# bestf10mod.3  7 -1435.526
...
#              df       AIC
# bestf11mod.1  5 -781.6388
# bestf11mod.2  6 -786.5677
# bestf11mod.3  7 -793.1304
...
write.csv(ModOverview, "../04Outputs/Durham/Dur_ModelOverviewResults_2mod4.csv")
