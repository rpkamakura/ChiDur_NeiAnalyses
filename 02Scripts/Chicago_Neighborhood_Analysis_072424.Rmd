...
ChiCors <- cor(Seg_allData[,c("PercComm_z", "PercCOMM_MxTree", "PercRes_z","NumConst_since11","NumReno_since11", 
                  "AllConst_since11",  "NumBuild", "SVI", "AftTemp","Change_PHL", "Change_PBl","Change_PWnHL",
...
f2 <- "PercCOMM_MxTree + AllConst_since11 + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"
...
vif(bestf4mod.1) #all below 3
vif(bestf4mod.2) #all below 5
...
# bestf4mod.2  7 -3267.400

#write.csv(f4sum.2$coefficients$mean, "../04Outputs/Chicago/Chi_SimpsonSpp_Best_2mod2.csv")
...
# bestf5mod.2  8 -2623.212

#write.csv(f5sum.2$coefficients$mean, "../04Outputs/Chicago/Chi_SimpsonGen_Best_2mod2.csv")
...
#write.csv(f6sum.1$coefficients, "../04Outputs/Chicago/Chi_AvgBA_Best_2mod2.csv")
...
f2.2 <- "PercComm_z + AllConst_since11 + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"
...
#write.csv(f7sum.1$coefficients, "../04Outputs/Chicago/Chi_NumTrees_Best_2mod2.csv")
...
# bestf8mod.2  8 -1610.198

#write.csv(f8sum.2$coefficients, "../04Outputs/Chicago/Chi_UrbanApp_Best_2mod2.csv")
...
# bestf9mod.2  8 -3530.304


#write.csv(f9sum.1$coefficients, "../04Outputs/Chicago/Chi_Discol_Best_2mod2.csv")
...
# bestf10mod.2  7 -3159.958

#write.csv(f10sum.2$coefficients, "../04Outputs/Chicago/Chi_DBK_Best_2mod2.csv")
...
# bestf11mod.2  8 -3310.826


#write.csv(f11sum.2$coefficients, "../04Outputs/Chicago/Chi_CS_Best_2mod2.csv")
...
modList <- list(f4sum.2, f5sum.2, f6sum.1, f7sum.1, f8sum.2, f9sum.1, f10sum.2, f11sum.1)
...
write.csv(ModOverview, "../04Outputs/Chicago/Chi_ModelOverviewResults_2mod2.csv")
