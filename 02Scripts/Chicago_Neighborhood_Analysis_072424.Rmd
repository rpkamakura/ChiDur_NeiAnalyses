...
f2 <- "PercCOMM_MxTree + AllConst_since11 + Change_PWnHL + Change_MedHHI + Avg_Rmov"
...
#write.csv(f4sum.2$coefficients$mean, "../04Outputs/Chicago/Chi_SimpsonSpp_Best_2mod3.csv")
...
#             df      AIC
# bestf5mod.1  6 -2615.21
# bestf5mod.2  6 -2615.21

#write.csv(f5sum.1$coefficients$mean, "../04Outputs/Chicago/Chi_SimpsonGen_Best_2mod3.csv")
...
#             df       AIC
# bestf6mod.1  3 -36.79102
# bestf6mod.2  6 -35.23863

#write.csv(f6sum.1$coefficients, "../04Outputs/Chicago/Chi_AvgBA_Best_2mod3.csv")
...
f2.2 <- "PercComm_z + AllConst_since11 + Change_PWnHL + Change_MedHHI + Avg_Rmov"
...
#write.csv(f7sum.1$coefficients, "../04Outputs/Chicago/Chi_NumTrees_Best_2mod3.csv")
...
#             df       AIC
# bestf8mod.1  7 -1480.861
# bestf8mod.2  7 -1635.957

#write.csv(f8sum.2$coefficients, "../04Outputs/Chicago/Chi_UrbanApp_Best_2mod3.csv")
...
#             df       AIC
# bestf9mod.1  6 -2420.055
# bestf9mod.2  6 -2570.353

#write.csv(f9sum.2$coefficients, "../04Outputs/Chicago/Chi_Discol_Best_2mod3.csv")
...
#              df       AIC
# bestf10mod.1  5 -3050.426
# bestf10mod.2  6 -3126.899


#write.csv(f10sum.2$coefficients, "../04Outputs/Chicago/Chi_DBK_Best_2mod3.csv")
...
#              df       AIC
# bestf11mod.1  7 -2420.421
# bestf11mod.2  6 -2592.154

#write.csv(f11sum.2$coefficients, "../04Outputs/Chicago/Chi_CS_Best_2mod3.csv")
...
write.csv(ModOverview, "../04Outputs/Chicago/Chi_ModelOverviewResults_2mod3.csv")
