...
DurCors <- cor(Seg_allData[,c("PercComm_z", "PercRes_z","NumConst_since15","NumReno_since15", 
                   "NumBuild", "SVI","Change_PHL", "Change_PBl","Change_PWnHL",
                   "Change_MedHHI", "Change_PRent","Change_Rmov", "PercWhiteNonHL21",
...
f1 <- "PercCOMM_MxTree + NumBuild"
f2 <- "PercCOMM_MxTree + SVI + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"
f3 <- "PercCOMM_MxTree + NumConst_since15 + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"
f4 <- "PercCOMM_MxTree + NumReno_since15 + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"

##can have construction and renovations together here
f5 <- "PercCOMM_MxTree + NumConst_since15 + NumReno_since15 + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"
...
#             df       AIC
# bestf1mod.1  4 -3388.241
# bestf1mod.2  6 -3423.536
# bestf1mod.3  6 -3458.136
# bestf1mod.4  8 -4454.274**
# bestf1mod.5  9 -4454.074**


#write.csv(f1sum.4$coefficients$mean, "../04Outputs/Durham/Dur_SC_Best_m4.csv")
...
#             df       AIC
# bestf2mod.1  4  5.723368
# bestf2mod.2  7  4.184177
# bestf2mod.3  5 -3.323320**
# bestf2mod.4  5  5.918871
# bestf2mod.5  5 -3.323320


#write.csv(f2sum.3$coefficients, "../04Outputs/Durham/Dur_Temperature_Best_m3.csv")
...
#             df       AIC
# bestf3mod.1  3 -1462.871
# bestf3mod.2  8 -1655.624
# bestf3mod.3  5 -1755.701
# bestf3mod.4  7 -1696.870
# bestf3mod.5  9 -1845.119**

#write.csv(f3sum.5$coefficients$mean, "../04Outputs/Durham/Dur_Gardenscape_Best_m5.csv")
...
#             df        AIC
# bestf4mod.1  4  -850.0232
# bestf4mod.2  8 -1295.8544
# bestf4mod.3  8 -1368.7446
# bestf4mod.4  8 -1578.8198
# bestf4mod.5  9 -1619.3286 **


#write.csv(f4sum.5$coefficients$mean, "../04Outputs/Durham/Dur_SimpsonSpp_Best_m5.csv")
...
#             df        AIC
# bestf5mod.1  4  -945.2676
# bestf5mod.2  8 -1629.5723**
# bestf5mod.3  8 -1498.4461
# bestf5mod.4  8 -1554.1133
# bestf5mod.5  9 -1562.3601

#write.csv(f5sum.2$coefficients$mean, "../04Outputs/Durham/Dur_SimpsonGen_Best_m2.csv")
...
#a bunch are similar here
#             df       AIC
# bestf6mod.1  2 -30.37880
# bestf6mod.2  6 -28.91230
# bestf6mod.3  7 -30.53422**
# bestf6mod.4  2 -30.37880
# bestf6mod.5  7 -30.53422


#write.csv(f6sum.3$coefficients, "../04Outputs/Durham/Dur_AvgBA_Best_m3.csv")
...
#write.csv(f7sum.5$coefficients, "../04Outputs/Durham/Dur_NumTrees_Best_m5.csv")
...
#             df       AIC
# bestf8mod.1  4 -351.7478
# bestf8mod.2  8 -909.8962**
# bestf8mod.3  6 -827.7975
# bestf8mod.4  6 -801.2867
# bestf8mod.5  6 -866.1639

#write.csv(f8sum.2$coefficients, "../04Outputs/Durham/Dur_UrbanApp_Best_m2.csv")
...
#             df       AIC
# bestf9mod.1  4 -492.5322
# bestf9mod.2  7 -767.3458
# bestf9mod.3  8 -754.6013
# bestf9mod.4  8 -746.4492
# bestf9mod.5  9 -793.7818 **


#write.csv(f9sum.5$coefficients, "../04Outputs/Durham/Dur_Discol_Best_m5.csv")
...
#              df       AIC
# bestf10mod.1  3 -1264.623
# bestf10mod.2  7 -1567.648
# bestf10mod.3  8 -1614.379
# bestf10mod.4  8 -1609.103
# bestf10mod.5  9 -1632.807**

#write.csv(f10sum.5$coefficients, "../04Outputs/Durham/Dur_DBK_Best_m5.csv")
...
#              df       AIC
# bestf11mod.1  3 -687.6144
# bestf11mod.2  8 -939.9981 **
# bestf11mod.3  8 -915.5414
# bestf11mod.4  8 -916.3679
# bestf11mod.5  8 -915.5414


#write.csv(f11sum.2$coefficients, "../04Outputs/Durham/Dur_CS_Best_m2.csv")
...
modList <- list(f1sum.4, f2sum.3, f3sum.5, f4sum.5, f5sum.2, f6sum.3, f7sum.5, f8sum.2, f9sum.5, f10sum.5, f11sum.2)
