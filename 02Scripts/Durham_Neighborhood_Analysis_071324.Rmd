...
f3 <- "PercCOMM_MxTree + NumConst_since11 + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"
f4 <- "PercCOMM_MxTree + NumReno_since11 + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"

##can have construction and renovations together here
f5 <- "PercCOMM_MxTree + NumConst_since11 + NumReno_since11 + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"
...
##Number of Trees
f1.2 <- "PercComm_z + NumBuild"
f2.2 <- "PercComm_z + SVI + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"
f3.2 <- "PercComm_z + NumConst_since11 + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"
f4.2 <- "PercComm_z + NumReno_since11 + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"
f5.2 <- "PercComm_z + NumConst_since11 + NumReno_since11 + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"

mods_m7 <- paste(rep("totNumTrees ~", 5), c(f1.2, f2.2, f3.2, f4.2, f5.2))
