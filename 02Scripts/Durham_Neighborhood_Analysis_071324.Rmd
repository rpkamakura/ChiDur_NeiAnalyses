...
# bestf1mod.3  7 -3436.434
# bestf1mod.4  8 -4378.774
# bestf1mod.5  9 -4399.251*


#write.csv(f1sum.5$coefficients$mean, "../04Outputs/Durham/Dur_SC_Best_m5.csv")
...
# bestf2mod.3  5 -4.064296*
# bestf2mod.4  5  5.918871
# bestf2mod.5  5 -4.064296
...
# bestf3mod.3  6 -1713.702
# bestf3mod.4  7 -1691.205
# bestf3mod.5  9 -1796.296*
...
# bestf4mod.3  8 -1282.5235
# bestf4mod.4  8 -1579.2554
# bestf4mod.5  9 -1604.2568*
...
# bestf5mod.3  8 -1466.5969
# bestf5mod.4  8 -1556.0828
# bestf5mod.5  9 -1558.2191
...
# bestf6mod.3  7 -31.43376*
# bestf6mod.4  2 -30.37880
# bestf6mod.5  7 -31.43376
...
# bestf8mod.3  8 -875.8843
# bestf8mod.4  6 -797.9389
# bestf8mod.5  9 -915.9573*

#write.csv(f8sum.5$coefficients, "../04Outputs/Durham/Dur_UrbanApp_Best_m5.csv")
...
# bestf9mod.3  7 -745.5994
# bestf9mod.4  8 -759.5739
# bestf9mod.5  9 -799.5593*
...
# bestf10mod.3  8 -1601.415
# bestf10mod.4  7 -1632.952
# bestf10mod.5  9 -1643.470*
...
# bestf11mod.3  8 -914.8478
# bestf11mod.4  8 -917.7186
# bestf11mod.5  9 -915.7423
...
modList <- list(f1sum.5, f2sum.3, f3sum.5, f4sum.5, f5sum.2, f6sum.3, f7sum.5, f8sum.5, f9sum.5, f10sum.5, f11sum.2)
