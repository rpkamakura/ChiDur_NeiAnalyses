...
f1 <- "PercCOMM_MxTree + SVI + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"
f2 <- "PercCOMM_MxTree + NumConst_since11 + NumReno_since11 + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"
...
#             df       AIC
# bestf1mod.1  6 -3423.536
# bestf1mod.2  9 -4399.251


#write.csv(f1sum.2$coefficients$mean, "../04Outputs/Durham/Dur_SC_Best_2mod.csv")
...
#             df       AIC
# bestf2mod.1  7  4.184177
# bestf2mod.2  5 -4.064296

#write.csv(f2sum.2$coefficients, "../04Outputs/Durham/Dur_Temperature_Best_2mod.csv")
...
#             df       AIC
# bestf3mod.1  8 -1655.624
# bestf3mod.2  9 -1796.296

#write.csv(f3sum.2$coefficients$mean, "../04Outputs/Durham/Dur_Gardenscape_Best_2mod.csv")
...
#             df       AIC
# bestf4mod.1  8 -1295.854
# bestf4mod.2  9 -1604.257

#write.csv(f4sum.2$coefficients$mean, "../04Outputs/Durham/Dur_SimpsonSpp_Best_2mod.csv")
...
#             df       AIC
# bestf5mod.1  8 -1629.572
# bestf5mod.2  9 -1558.219


#write.csv(f5sum.1$coefficients$mean, "../04Outputs/Durham/Dur_SimpsonGen_Best_2mod.csv")
...
#             df       AIC
# bestf6mod.1  6 -28.91230
# bestf6mod.2  7 -31.43376

#write.csv(f6sum.2$coefficients, "../04Outputs/Durham/Dur_AvgBA_Best_2mod.csv")

##Number of Trees
f1.2 <- "PercComm_z + SVI + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"
f2.2 <- "PercComm_z + NumConst_since11 + NumReno_since11 + Change_PWnHL + Change_MedHHI + Change_PRent + Change_Rmov"
...
#write.csv(f7sum.2$coefficients, "../04Outputs/Durham/Dur_NumTrees_Best_2mod.csv")
...
#             df       AIC
# bestf8mod.1  8 -909.8962
# bestf8mod.2  9 -915.9573


#write.csv(f8sum.2$coefficients, "../04Outputs/Durham/Dur_UrbanApp_Best_2mod.csv")
...
#             df       AIC
# bestf9mod.1  7 -767.3458
# bestf9mod.2  9 -799.5593

#write.csv(f9sum.2$coefficients, "../04Outputs/Durham/Dur_Discol_Best_2mod.csv")
...
#              df       AIC
# bestf10mod.1  7 -1567.648
# bestf10mod.2  9 -1643.470

#write.csv(f10sum.2$coefficients, "../04Outputs/Durham/Dur_DBK_Best_2mod.csv")
...
#              df       AIC
# bestf11mod.1  8 -939.9981
# bestf11mod.2  9 -915.7423

#write.csv(f11sum.1$coefficients, "../04Outputs/Durham/Dur_CS_Best_2mod.csv")
...
modList <- list(f1sum.2, f2sum.2, f3sum.2, f4sum.2, f5sum.1, f6sum.2, f7sum.2, f8sum.2, f9sum.2, f10sum.2, f11sum.1)
...
write.csv(ModOverview, "../04Outputs/Durham/Dur_ModelOverviewResults_2mod.csv")
