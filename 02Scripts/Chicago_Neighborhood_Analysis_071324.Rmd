...
ChiCors <- cor(Seg_allData[,c("PercComm_z", "PercRes_z","NumConst_since11","NumReno_since11", 
...
#construction and renovations are correlated...not sure if still worth it?
...
#             df       AIC
# bestf1mod.1  4 -2264.006
# bestf1mod.2  8 -3348.053
# bestf1mod.3  7 -3309.873
# bestf1mod.4  8 -3315.570
# bestf1mod.5  9 -3407.152*


#write.csv(f1sum.5$coefficients$mean, "../04Outputs/Chicago/Chi_SC_Best_m5.csv")
...
#             df       AIC
# bestf3mod.1  4 -1355.406
# bestf3mod.2  8 -1873.089
# bestf3mod.3  7 -1961.840*
# bestf3mod.4  6 -1882.298
# bestf3mod.5  7 -1961.840



#write.csv(f3sum.3$coefficients$mean, "../04Outputs/Chicago/Chi_Gardenscape_Best_m3.csv")
