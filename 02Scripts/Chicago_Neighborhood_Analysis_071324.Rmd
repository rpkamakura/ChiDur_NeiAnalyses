...
# bestf1mod.3  8 -3341.523
# bestf1mod.4  8 -3326.014
# bestf1mod.5  9 -3550.972**
...
# bestf3mod.3  8 -2147.295
# bestf3mod.4  8 -2107.865
# bestf3mod.5  8 -2193.759*



#write.csv(f3sum.5$coefficients$mean, "../04Outputs/Chicago/Chi_Gardenscape_Best_m5.csv")
...
#             df       AIC
# bestf4mod.1  3 -3082.350
# bestf4mod.2  6 -3246.986
# bestf4mod.3  7 -3295.505
# bestf4mod.4  6 -3319.493
# bestf4mod.5  8 -3573.694*


#write.csv(f4sum.5$coefficients$mean, "../04Outputs/Chicago/Chi_SimpsonSpp_Best_m5.csv")
...
#             df       AIC
# bestf5mod.1  3 -2394.681
# bestf5mod.2  7 -2616.589
# bestf5mod.3  8 -2653.120
# bestf5mod.4  7 -2650.837
# bestf5mod.5  8 -2794.004*

#write.csv(f5sum.5$coefficients$mean, "../04Outputs/Chicago/Chi_SimpsonGen_Best_m5.csv")
...
# bestf6mod.3  7 -35.91381
# bestf6mod.4  6 -35.79276
# bestf6mod.5  7 -35.91381
...
#             df       AIC
# bestf8mod.1  4 -1264.248
# bestf8mod.2  7 -1589.820
# bestf8mod.3  8 -1622.265*
# bestf8mod.4  8 -1602.520
# bestf8mod.5  8 -1622.265

#write.csv(f8sum.3$coefficients, "../04Outputs/Chicago/Chi_UrbanApp_Best_m3.csv")
...
#             df       AIC
# bestf9mod.1  4 -2442.663
# bestf9mod.2  8 -3583.963
# bestf9mod.3  8 -3652.016
# bestf9mod.4  8 -3616.391
# bestf9mod.5  9 -4352.007*

#write.csv(f9sum.5$coefficients, "../04Outputs/Chicago/Chi_Discol_Best_m5.csv")
...
# bestf10mod.3  5 -3255.664*
# bestf10mod.4  6 -3125.123
# bestf10mod.5  5 -3255.664
...
#              df       AIC
# bestf11mod.1  4 -2454.136
# bestf11mod.2  8 -3314.847
# bestf11mod.3  8 -3506.452
# bestf11mod.4  8 -3322.785
# bestf11mod.5  9 -3703.837*


#write.csv(f11sum.5$coefficients, "../04Outputs/Chicago/Chi_CS_Best_m5.csv")
...
modList <- list(f1sum.5, f2sum.2, f3sum.5, f4sum.5, f5sum.5, f6sum.1, f7sum.1, f8sum.3, f9sum.5, f10sum.3, f11sum.5)
