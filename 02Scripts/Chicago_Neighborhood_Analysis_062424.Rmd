...
##read in data
basicDataPath <- c("../../01Data/02ChicagoSampling/")

#read in full version of the tree dataset
TreeLvlCombined <- read.csv("../../01Data/02ChicagoSampling/StreetTreeData_v2023/091223AllYearsComb.csv")

TodayDate <- Sys.Date()
date <- format(TodayDate, format="%b%d%y")

##census data
CensusData <- read.csv("../../01Data/CityData/Chicago/Chicago_SegmentCensusData.csv")
SVIData <- read.csv("../../01Data/CityData/Chicago/CookCounty_SVI.csv")

##zoning data
ZoningData <- read.csv("../../01Data/CityData/Chicago/Zoning_wSeg.csv")
ZoningDescr <- read.csv("../../01Data/02ChicagoSampling/ChicagoZoningDescriptions.csv")

#building data
BFoot  <- read.csv("../../01Data/CityData/Chicago/BuildingFootprints_wSeg.csv")
BPerm  <- read.csv("../../01Data/CityData/Chicago/BuildingPermits_wSeg_clean.csv")
BHei  <- read.csv("../../01Data/CityData/Chicago/Chicago_BuildingHeights.csv")
...
for (m in 1:11){
  ...
  #write.csv(pm, paste("../../01Data/CityData/Chicago/BetaVals", modDep[m], "since15_062824.csv", sep=""))
