...
CensusTracts2010$MedHouseIncome <- MedHouseInc2011_est$MedIncome2021Dolars[match(CensusTracts2010$LOCATION, MedHouseInc2011_est$Census.Tract)]
...
###############################################2021 data
CensusTracts2020$PercHispLat <- as.numeric(HispLat2021_est$Total...Hispanic.or.Latino.[match(CensusTracts2020$NAMELSAD, HispLat2021_est$CensusTract)])/as.numeric(HispLat2021$Total.[match(CensusTracts2020$NAMELSAD, HispLat2021_est$CensusTract)])
...
CensusTracts2020$PercBlack <- (as.numeric(HispLat2021_est$Total...Not.Hispanic.or.Latino...Black.or.African.American.alone[match(CensusTracts2020$NAMELSAD, HispLat2021_est$CensusTract)]) + as.numeric(HispLat2021$Total...Hispanic.or.Latino...Black.or.African.American.alone[match(CensusTracts2020$NAMELSAD, HispLat2021$CensusTract)]))/as.numeric(HispLat2021$Total.[match(CensusTracts2020$NAMELSAD, HispLat2021$CensusTract)])

CensusTracts2020$MedHouseIncome <- MedHouseInc2021$Median.household.income.in.the.past.12.months..in.2021.inflation.adjusted.dollars.[match(CensusTracts2020$NAMELSAD, MedHouseInc2021$Census.Tract)]
