...
#######################################2011 data
CensusTracts2010$PercHispLat <- as.numeric(HispLat2011_est$Total...Hispanic.or.Latino.[match(CensusTracts2010$LOCATION, HispLat2011_est$ï..Census.Tract)])/as.numeric(HispLat2011_est$Total.[match(CensusTracts2010$LOCATION, HispLat2011_est$ï..Census.Tract)])

CensusTracts2010$PercWhiteNonHisp <- as.numeric(HispLat2011_est$Total...Not.Hispanic.or.Latino...White.alone[match(CensusTracts2010$LOCATION, HispLat2011_est$ï..Census.Tract)])/as.numeric(HispLat2011_est$Total.[match(CensusTracts2010$LOCATION, HispLat2011_est$ï..Census.Tract)])

CensusTracts2010$PercBlack <- (as.numeric(HispLat2011_est$Total...Not.Hispanic.or.Latino...Black.or.African.American.alone[match(CensusTracts2010$LOCATION, HispLat2011_est$ï..Census.Tract)]) + as.numeric(HispLat2011_est$Total...Hispanic.or.Latino...Black.or.African.American.alone[match(CensusTracts2010$LOCATION, HispLat2011_est$ï..Census.Tract)]))/as.numeric(HispLat2011_est$Total.[match(CensusTracts2010$LOCATION, HispLat2011_est$ï..Census.Tract)])

CensusTracts2010$MedHouseIncome <- as.numeric(MedHouseInc2011_est$MedIncome2021Dolars[match(CensusTracts2010$LOCATION, MedHouseInc2011_est$ï..Census.Tract)])

CensusTracts2010$PercRenter <- as.numeric(HousingTenure2011_est$Total...Renter.occupied.[match(CensusTracts2010$LOCATION,HousingTenure2011_est$ï..Census.Tract)])/as.numeric(HousingTenure2011_est$Total.[match(CensusTracts2010$LOCATION,HousingTenure2011_est$ï..Census.Tract)])

CensusTracts2010$PercMovL5Years <- c(as.numeric(HousingTenure2011_est$Total...Owner.occupied...Moved.in.2005.or.later[match(CensusTracts2010$LOCATION,HousingTenure2011_est$ï..Census.Tract)]) + as.numeric(HousingTenure2011_est$Total...Renter.occupied...Moved.in.2005.or.later[match(CensusTracts2010$LOCATION,HousingTenure2011_est$ï..Census.Tract)]))/as.numeric(HousingTenure2011_est$Total.[match(CensusTracts2010$LOCATION,HousingTenure2011_est$ï..Census.Tract)])



###############################################2021 data
CensusTracts2020$PercHispLat <- as.numeric(HispLat2021_est$Total...Hispanic.or.Latino.[match(CensusTracts2020$NAMELSAD, HispLat2021_est$ï..CensusTract)])/as.numeric(HispLat2021_est$Total.[match(CensusTracts2020$NAMELSAD, HispLat2021_est$ï..CensusTract)])

CensusTracts2020$PercWhiteNonHisp <- as.numeric(HispLat2021_est$Total...Not.Hispanic.or.Latino...White.alone[match(CensusTracts2020$NAMELSAD, HispLat2021_est$ï..CensusTract)])/as.numeric(HispLat2021_est$Total.[match(CensusTracts2020$NAMELSAD, HispLat2021_est$ï..CensusTract)])

CensusTracts2020$PercBlack <- (as.numeric(HispLat2021_est$Total...Not.Hispanic.or.Latino...Black.or.African.American.alone[match(CensusTracts2020$NAMELSAD, HispLat2021_est$ï..CensusTract)]) + as.numeric(HispLat2021_est$Total...Hispanic.or.Latino...Black.or.African.American.alone[match(CensusTracts2020$NAMELSAD, HispLat2021_est$ï..CensusTract)]))/as.numeric(HispLat2021_est$Total.[match(CensusTracts2020$NAMELSAD, HispLat2021_est$ï..CensusTract)])

CensusTracts2020$MedHouseIncome <- as.numeric(MedHouseInc2021$Median.household.income.in.the.past.12.months..in.2021.inflation.adjusted.dollars.[match(CensusTracts2020$NAMELSAD, MedHouseInc2021$ï..Census.Tract)])

CensusTracts2020$PercRenter <- as.numeric(HousingTenure2021_est$Total...Renter.occupied.[match(CensusTracts2020$NAMELSAD, HousingTenure2021_est$ï..Census.Tract)])/as.numeric(HousingTenure2021_est$Total.[match(CensusTracts2020$NAMELSAD, HousingTenure2021_est$ï..Census.Tract)])

CensusTracts2020$PercMovL5Years <- c(as.numeric(HousingTenure2021_est$Total...Owner.occupied...Moved.in.2019.or.later[match(CensusTracts2020$NAMELSAD, HousingTenure2021_est$ï..Census.Tract)]) + as.numeric(HousingTenure2021_est$Total...Renter.occupied...Moved.in.2019.or.later[match(CensusTracts2020$NAMELSAD, HousingTenure2021_est$ï..Census.Tract)]) + as.numeric(HousingTenure2021_est$Total...Owner.occupied...Moved.in.2015.to.2018[match(CensusTracts2020$NAMELSAD, HousingTenure2021_est$ï..Census.Tract)]) + as.numeric(HousingTenure2021_est$Total...Renter.occupied...Moved.in.2015.to.2018[match(CensusTracts2020$NAMELSAD, HousingTenure2021_est$ï..Census.Tract)]))/as.numeric(HousingTenure2021_est$Total.[match(CensusTracts2020$NAMELSAD, HousingTenure2021_est$ï..Census.Tract)])
...
SegmentCensusData$Change_PRent <- SegmentCensusData$PercRent21 - SegmentCensusData$PercRent11
SegmentCensusData$Change_Rmov <- SegmentCensusData$PercRMov21 - SegmentCensusData$PercRMov11
...
Seg_building$NumDemo_since19[match(rownames(perm_yrs_demo), Seg_building$Segment)]  <- rowSums(perm_yrs_demo[,c("2020", "2021", "2022", "2023")])
...
#write.csv(corVars, "../01Data/Durham/Durham_Predictor_corrs.csv")
...
#write.csv(ModOverview, "../01Data/Durham/Dur_ModelOverviewResults_Since15_062824.csv")
